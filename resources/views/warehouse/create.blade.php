...
<div class="container mt-5"> 
    {{-- {{ Breadcrumbs::render('dwpayment_create') }}  --}}
    <div class="row justify-content-center align-items-center"> 
        <div class="card" style="width: 24rem;"> 
            <div class="card-header"> 
            <center>Tambah Tabel Pada Warehouse Clickhouse</center>  
            </div> 
            <div class="card-body"> 
                @if ($errors->any()) 
            ...
            @endif 
            <form method="post" action="{{ route('storetable2') }}" id="myForm" enctype="multipart/form-data"> 
            @csrf 
                @foreach ($data as $d)
                @if ($d['serviceType'] == 'Clickhouse')
